...
public class Ship implements Serializable {
    ...
    private int imo;
    /**
     * Name of the ship : Maximum 20 characters 6-bit ASCII, as defined in Table 44.
    ...
    /**
     * Course over ground in 1/10deg (0-3 599). 3 600
     * (E10h) = not available = default;
     ...
     * 0 to -126 = turning left at up to 708 deg per min or higher Values between 0 and 708 deg per min
     * coded by ROTAIS = 4.733 SQRT(ROTsensor) degrees per min where ROTsensor is the Rate of Turn
     * as input by an external Rate of Turn Indicator (TI).
     ...
     * harmful substances (HS) or marine pollutants (MP), or IMO hazard or pollutant category A,
     * wing in grand (WIG);
